...
export const chipTheme = cva(
  'inline-flex items-center font-medium whitespace-nowrap rounded-full transition-colors select-none',
  {
    ...
    compoundVariants: [
      ...
      { variant: 'ghost', color: 'accent', class: 'text-ousi-accent' },
      ...
      { variant: 'ghost', color: 'success', class: 'text-ousi-success' },
      ...
      { variant: 'ghost', color: 'warning', class: 'text-ousi-warning' },
      ...
      { variant: 'ghost', color: 'danger', class: 'text-ousi-danger' },
      ...
      { variant: 'ghost', color: 'default', class: 'text-ousi-default-foreground' },
    ],
    defaultVariants: {
      variant: 'solid',
      size: 'md',
